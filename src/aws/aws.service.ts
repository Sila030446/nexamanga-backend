  ...
  async uploadImageFromUrl(
    ...
    try {
      const response = await axios.get(imageUrl, {
        ...
        maxContentLength: Infinity, // กำหนดให้ไม่มีขีดจำกัดสำหรับขนาดเนื้อหา
        maxBodyLength: Infinity, // กำหนดให้ไม่มีขีดจำกัดสำหรับขนาดข้อมูลที่ส่ง
      });
      ...
      // สร้างโครงสร้างโฟลเดอร์ตามชื่อมังงะและชื่อตอน
