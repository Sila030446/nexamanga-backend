...
export const startGoMangaScraping = async (
  page: Page,
  url: string,
  ...
  try {
    ...
    const manga = await page.evaluate(() => {
      ...
      const alternativeTitle =
        document.querySelector('div.seriestucon > div.seriestuheader > div')
          ?.textContent || '';
      ...
      const description =
        document.querySelector(
          'div.seriestucontent > div.seriestucontentr > div.seriestuhead > div.entry-content.entry-content-single > p',
      ...
      const authors = getText(
        'div.seriestucont > div > table > tbody > tr:nth-child(4) > td:nth-child(2)',
      );
      const artist = getText(
        'div.seriestucont > div > table > tbody > tr:nth-child(5) > td:nth-child(2)',
      );

      const type = getText(
        'div.seriestucont > div > table > tbody > tr:nth-child(2) > td:nth-child(2)',
      );
